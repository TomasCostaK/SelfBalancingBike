...
void setup() {
  ...
  long TCCR1B = TCCR1B & 0b11111000 | 0x01; // set PWM frequency @ 31250 Hz for Pins 9 and 10
  long TCCR2B = TCCR2B & 0b11111000 | 0x01; // set PWM frequency @ 31250 Hz for Pins 11 and 3 (3 not used)
  //  ICR1 = 255 ; // 8 bit resolution
  long ICR1 = 1023 ; // 10 bit resolution
